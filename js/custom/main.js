(function($) {
    ...
    function controller() {
        ...
        var urlD = 'api/deck_object.php';
        $.getJSON(url, function(deck) {
            if (deck.winner == true) {
                console.log(deck._users[deck.playerTurn].name);
            };
        });
        botPlayCard();
        ...
        $.getJSON(url, function(deck) {
           ...
           /* if (deck._thrownCards[0]._value != 8) {*/
            ...
            /*}else{
                console.log('It is 8');
 $('body').prepend('<div class="chose-suit"><img id="heart" src="img/heart.png"/><img id="spades" src="img/spades.png"/><img id="diamonds" src="img/diamonds.png"/><img id="clubs" src="img/clubs.png"/></div>');
            }*/
